...
export function PaymentHistory({ payments, totalSale, currency }: PaymentHistoryProps) {
      ...
      <Card className="p-4">
        <div className="grid grid-cols-3 gap-4 text-center">
          <div>
            ...
            <p className="text-lg font-semibold">{formatCurrency(totalSale, currency)}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className={`text-lg font-semibold ${pendingBalance > 0 ? 'text-red-600' : 'text-green-600'}`}>
